                ...
                <div class="card-body">
                  <table id="productsTable" class="table table-hover table-product" style="width:100%">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td class="py-0">
                          <img src="{{asset('assets/admin/images/products/products-xs-01.jpg')}}" alt="Product Image">
                        </td>
                        <td>Coach Swagger</td>
                        <td>24541</td>
                        <td>27</td>
                      ...
                      <tr>
                        <td class="py-0">
                          <img src="{{asset('assets/admin/images/products/products-xs-02.jpg')}}" alt="Product Image">
                        </td>
                      ...
                      <tr>
                        <td class="py-0">
                          <img src="{{asset('assets/admin/images/products/products-xs-03.jpg')}}" alt="Product Image">
                        </td>
