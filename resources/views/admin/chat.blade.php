...
<ul class="card-body px-0" data-simplebar style="height: 630px;">
  <li class="mb-4 px-5 py-2">
    <a href="javascript:void(0)" class="media media-message">
      <div class="position-relative mr-3">
        <img class="rounded-circle" src="{{asset('assets/admin/images/user/user-sm-01.jpg')}}" alt="User Image">
  ...
  <li class="mb-4 px-5 py-2">
    <a href="javascript:void(0)" class="media media-message">
      <div class="position-relative mr-3">
        <img class="rounded-circle" src="{{asset('assets/admin/images/user/user-sm-02.jpg')}}" alt="User Image">
        <span class="status away"></span>
      </div>
  ...
  <li class="bg-primary mb-4 px-5 py-2">
    <a href="javascript:void(0)" class="media media-message">
      <div class="position-relative mr-3">
        <img class="rounded-circle" src="{{asset('assets/admin/images/user/user-sm-03.jpg')}}" alt="User Image">
  ...
  <li class="mb-4 px-5 py-2">
    <a href="javascript:void(0)" class="media media-message">
      <div class="position-relative mr-3">
        <img class="rounded-circle" src="{{asset('assets/admin/images/user/user-sm-04.jpg')}}" alt="User Image">
        <span class="status away"></span>
      </div>
  ...
  <li class="mb-4 px-5 py-2">
    <a href="javascript:void(0)" class="media media-message">
      <div class="position-relative mr-3">
        <img class="rounded-circle" src="{{asset('assets/admin/images/user/user-sm-05.jpg')}}" alt="User Image">
        <span class="status away"></span>
      </div>
...
<div class="card-body pb-0" data-simplebar style="height: 545px;">
  ...
  <div class="media media-chat">
    <img src="{{asset('assets/admin/images/user/user-sm-01.jpg')}}" class="rounded-circle" alt="Avata Image">
    <div class="media-body">
  ...
  <div class="media media-chat media-chat-right">
    ...
    <img src="{{asset('assets/admin/images/user/user-sm-02.jpg')}}" class="rounded-circle" alt="Avata Image">
  </div>
